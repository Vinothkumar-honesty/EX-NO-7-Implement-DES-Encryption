...
pt = input("Enter 16-hex-digit plaintext: ").upper()
key = input("Enter 16-hex-digit key: ").upper()

if len(pt) != 16 or len(key) != 16:
    print("Error: Must be exactly 16 hexadecimal characters.")
    exit()
print()
key = permute(hex2bin(key), keyp, 56)
...
for i in range(16):
    ...
    rkb.append(permute(left + right, key_comp, 48))

cipher_text = encrypt(pt, rkb)
print("Encrypted Cipher Text:", cipher_text)

decrypted_text = encrypt(cipher_text, rkb[::-1])
...
<img width="891" height="822" alt="image" src="https://github.com/user-attachments/assets/c6f6ce19-550b-4939-a0e8-544c3981f581" />
